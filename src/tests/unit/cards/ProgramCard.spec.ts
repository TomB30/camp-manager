...
describe("ProgramCard", () => {
  ...
  describe("Rendering", () => {
    it("renders program name correctly", () => {
      const program: Program = { ...programsFixture[0], meta: { ...programsFixture[0].meta, name: "Program 1" } };
    ...
    it("renders program description when provided", () => {
      const program: Program = { ...programsFixture[0], meta: { ...programsFixture[0].meta, description: "Program 1 description" } };
      const wrapper = createWrapper(ProgramCard, {
        props: { program },
        pinia,
      });
    ...
    it("does not render description section when no description", () => {
      const program: Program = { ...programsFixture[0], meta: { ...programsFixture[0].meta, description: undefined } };
      const wrapper = createWrapper(ProgramCard, {
        props: { program },
        pinia,
      });
  ...
  describe("Counts Display", () => {
    it("displays activities count", () => {
      const program: Program = { ...programsFixture[0], spec: { ...programsFixture[0].spec, activityIds: ["activity-1", "activity-2", "activity-3", "activity-4", "activity-5"] } };
      const wrapper = createWrapper(ProgramCard, {
        props: {
          program,
          activitiesCount: 5,
    ...
    it("displays staff count", () => {
      const program: Program = { ...programsFixture[0], spec: { ...programsFixture[0].spec, staffMemberIds: ["staff-1", "staff-2", "staff-3"] } };
      const wrapper = createWrapper(ProgramCard, {
        props: {
          program,
          staffCount: 3,
    ...
    it("displays locations count", () => {
      const program: Program = { ...programsFixture[0], spec: { ...programsFixture[0].spec, locationIds: ["location-1", "location-2", "location-3", "location-4"] } };
      const wrapper = createWrapper(ProgramCard, {
        props: {
          program,
          locationsCount: 4,
    ...
    it("handles zero counts", () => {
      const program: Program = { ...programsFixture[0], spec: { ...programsFixture[0].spec, activityIds: [], staffMemberIds: [], locationIds: [] } };
      const wrapper = createWrapper(ProgramCard, {
        props: {
          program,
        },
  ...
  describe("Color and Styling", () => {
    it("applies color border when color is set", () => {
      ...
      const program: Program = { ...programsFixture[0], spec: { ...programsFixture[0].spec, colorId: colorsFixture[0].meta.id } };
      const wrapper = createWrapper(ProgramCard, {
        props: { program },
        pinia,
      });
    ...
    it("uses default color when no color is set", () => {
      const program: Program = { ...programsFixture[0], spec: { ...programsFixture[0].spec, colorId: undefined } };
      const wrapper = createWrapper(ProgramCard, {
        props: { program },
        pinia,
      });
    ...
    it("has card-clickable class", () => {
      const program: Program = { ...programsFixture[0], meta: { ...programsFixture[0].meta, id: "program-1" } };
      const wrapper = createWrapper(ProgramCard, {
        props: { program },
        pinia,
      });
  ...
  describe("Edge Cases", () => {
    it("renders with all counts at maximum", () => {
      const program: Program = { ...programsFixture[0], spec: { ...programsFixture[0].spec, activityIds: ["activity-1", "activity-2", "activity-3", "activity-4", "activity-5", "activity-6", "activity-7", "activity-8", "activity-9", "activity-10"], staffMemberIds: ["staff-1", "staff-2", "staff-3", "staff-4", "staff-5", "staff-6", "staff-7", "staff-8", "staff-9", "staff-10"], locationIds: ["location-1", "location-2", "location-3", "location-4", "location-5", "location-6", "location-7", "location-8", "location-9", "location-10"] } };
      const wrapper = createWrapper(ProgramCard, {
        props: {
          program,
          staffCount: 10,
