  ...
  >
    ...
    <div class="group-info">
      ...
      <div v-if="isNestedGroup" class="info-item">
        ...
        <span>{{ childGroupCount }} child {{ childGroupCount === 1 ? 'group' : 'groups' }}</span>
      </div>
      ...
      <!-- Manual campers -->
      <div v-if="group.camperIds && group.camperIds.length > 0" class="info-item">
    ...
    <div v-if="group.camperFilters && hasAnyCamperFilters" class="group-filters">
    ...
    <div v-if="group.staffFilters && hasAnyStaffFilters" class="group-filters">
      ...
      <span v-if="group.staffFilters.certificationIds && group.staffFilters.certificationIds.length > 0" class="filter-tag">
        <strong>Certifications:</strong> {{ group.staffFilters.certificationIds.length }} required
      </span>
    </div>
  </div>
</template>
...
import { useLabelsStore, useColorsStore, useHousingRoomsStore, useSessionsStore } from '@/stores';
