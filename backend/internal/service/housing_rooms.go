...
type HousingRoomsService interface {
	...
	List(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, limit int, offset int, search *string) (*api.HousingRoomsListResponse, error)
...
// List retrieves housing rooms with pagination and optional search
func (s *housingRoomsService) List(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, limit int, offset int, search *string) (*api.HousingRoomsListResponse, error) {
	// TODO: Implement list logic
	return nil, nil
}

// GetByID retrieves a single housing room by ID
func (s *housingRoomsService) GetByID(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, id uuid.UUID) (*api.HousingRoom, error) {
...
// Update updates an existing housing room
func (s *housingRoomsService) Update(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, id uuid.UUID, req *api.HousingRoomUpdateRequest) (*api.HousingRoom, error) {
	// TODO: Implement update logic
	return nil, nil
}

// Delete deletes a housing room by ID
func (s *housingRoomsService) Delete(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, id uuid.UUID) error {
