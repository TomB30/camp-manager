...
type RolesService interface {
	...
	List(ctx context.Context, limit, offset int, search *string) (*api.RolesListResponse, error)
	...
	Update(ctx context.Context, id uuid.UUID, req *api.RoleUpdateRequest) (*api.Role, error)
...
// List retrieves roles with pagination and optional search
func (s *rolesService) List(ctx context.Context, limit, offset int, search *string) (*api.RolesListResponse, error) {
	// TODO: Implement list logic
	return nil, nil
}

// GetByID retrieves a single role by ID
func (s *rolesService) GetByID(ctx context.Context, id uuid.UUID) (*api.Role, error) {
...
// Update updates an existing role
func (s *rolesService) Update(ctx context.Context, id uuid.UUID, req *api.RoleUpdateRequest) (*api.Role, error) {
	// TODO: Implement update logic
	return nil, nil
}

// Delete deletes a role by ID
func (s *rolesService) Delete(ctx context.Context, id uuid.UUID) error {
