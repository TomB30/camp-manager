...
type GroupsService interface {
	...
	List(ctx context.Context, limit, offset int, search *string) (*api.GroupsListResponse, error)
	...
	Update(ctx context.Context, id uuid.UUID, req *api.GroupUpdateRequest) (*api.Group, error)
...
// List retrieves groups with pagination and optional search
func (s *groupsService) List(ctx context.Context, limit, offset int, search *string) (*api.GroupsListResponse, error) {
	// TODO: Implement list logic
	return nil, nil
}

// GetByID retrieves a single group by ID
func (s *groupsService) GetByID(ctx context.Context, id uuid.UUID) (*api.Group, error) {
...
// Update updates an existing group
func (s *groupsService) Update(ctx context.Context, id uuid.UUID, req *api.GroupUpdateRequest) (*api.Group, error) {
	// TODO: Implement update logic
	return nil, nil
}

// Delete deletes a group by ID
func (s *groupsService) Delete(ctx context.Context, id uuid.UUID) error {
