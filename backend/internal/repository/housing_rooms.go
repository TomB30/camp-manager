...
func (r *HousingRoomsRepository) List(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, limit int, offset int, search *string) ([]api.HousingRoom, int, error) {
	// TODO: Implement query with pagination and search
	return nil, 0, nil
}

// GetByID retrieves a single housing room by ID
func (r *HousingRoomsRepository) GetByID(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, id uuid.UUID) (*api.HousingRoom, error) {
...
func (r *HousingRoomsRepository) Update(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, id uuid.UUID, room *api.HousingRoom) error {
	// TODO: Implement UPDATE query
	return nil
}

// Delete removes a housing room by ID
func (r *HousingRoomsRepository) Delete(ctx context.Context, tenantId uuid.UUID, campId uuid.UUID, id uuid.UUID) error {
