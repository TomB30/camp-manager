...
export const groupsService = {
  ...
  createGroup: (data: GroupCreationRequest): Promise<Group> => impl().createGroup(data),
  updateGroup: (id: string, data: GroupUpdateRequest): Promise<Group> => impl().updateGroup(id, data),
