...
export const housingRoomsService = {
  ...
  createHousingRoom: (data: HousingRoomCreationRequest): Promise<HousingRoom> => impl().createHousingRoom(data),
  updateHousingRoom: (id: string, data: HousingRoomUpdateRequest): Promise<HousingRoom> => impl().updateHousingRoom(id, data),
  deleteHousingRoom: (id: string): Promise<void> => impl().deleteHousingRoom(id),
  getHousingRoomById: (id: string): Promise<HousingRoom | null> => impl().getHousingRoomById(id),
};
