...
export const activitiesService = {
  ...
  createActivity: (data: ActivityCreationRequest): Promise<Activity> => impl().createActivity(data),
  updateActivity: (id: string, data: ActivityUpdateRequest): Promise<Activity> => impl().updateActivity(id, data),
  deleteActivity: (id: string): Promise<void> => impl().deleteActivity(id),
  getActivityById: (id: string): Promise<Activity | null> => impl().getActivityById(id),
};
