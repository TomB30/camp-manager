...
export const deleteProgramById = <ThrowOnError extends boolean = false>(options: Options<DeleteProgramByIdData, ThrowOnError>) => {
    return (options.client ?? client).delete<DeleteProgramByIdResponses, DeleteProgramByIdErrors, ThrowOnError>({
...
export const deleteActivityById = <ThrowOnError extends boolean = false>(options: Options<DeleteActivityByIdData, ThrowOnError>) => {
    return (options.client ?? client).delete<DeleteActivityByIdResponses, DeleteActivityByIdErrors, ThrowOnError>({
 ...
 */
export const listImportJobs = <ThrowOnError extends boolean = false>(options: Options<ListImportJobsData, ThrowOnError>) => {
    return (options.client ?? client).get<ListImportJobsResponses, unknown, ThrowOnError>({
 ...
 */
export const getImportJobById = <ThrowOnError extends boolean = false>(options: Options<GetImportJobByIdData, ThrowOnError>) => {
    return (options.client ?? client).get<GetImportJobByIdResponses, unknown, ThrowOnError>({
 ...
 */
export const validateImport = <ThrowOnError extends boolean = false>(options: Options<ValidateImportData, ThrowOnError>) => {
    return (options.client ?? client).post<ValidateImportResponses, unknown, ThrowOnError>({
...
export const startImport = <ThrowOnError extends boolean = false>(options: Options<StartImportData, ThrowOnError>) => {
    return (options.client ?? client).post<StartImportResponses, unknown, ThrowOnError>({
        ...formDataBodySerializer,
 ...
 */
export const getImportTemplate = <ThrowOnError extends boolean = false>(options: Options<GetImportTemplateData, ThrowOnError>) => {
    return (options.client ?? client).get<GetImportTemplateResponses, unknown, ThrowOnError>({
